...
2. **Open an issue**: [GitHub Issues](https://github.com/yourusername/mdx-list-tables/issues)
3. **Start a discussion**: [GitHub Discussions](https://github.com/yourusername/mdx-list-tables/discussions)
